...
//PARAMETERS
    ...
    //5% of transaction fees will be distributed to hodlers
    //3% of transaction fees will be added to liquidity
    //1% of transaction fees will be burned
    //1% of transaction fees will be sent to a marketing/reserved fee wallet
    //2% buyback fee on sell transactions

    //max trasaction percentage: 5%

    //development wallet address: 0x55C77F05198c461f4b5eF3d34F2839ea7a0b9D86
    //marketing/reserved fee wallet address: 0xcc5Ca84567cFD52CB5F2573Fe973093824249bdf
    
    //developer's wallet: 0x69bF053EC4F7460e3624AC4A8AD86eB615F6F30a
    

//good luck for all hodlers :)
...
//contract
contract wj is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using SafeERC20 for IERC20;
    
    //details
    address dead = 0x000000000000000000000000000000000000dEaD;//burn address
    
    uint8 public maxLiqFee = 3;                // Transaction fee % that would be used to add liquidity 
    uint8 public maxTaxFee = 5;                // Transaction fee % that would be distributed to holders
    uint8 public maxBurnFee = 1;               // Transaction fee % that would be burned 
    uint8 public maxWalletFee = 1;             // Transaction fee % that would be sent to a marketing or charity wallet 
    ...
    uint8 public maxBuybackFee = 2;            // Transaction fee % that would be used to buyback tokens on sell (Hyper-deflation) (0-10)
    ...
    //router
    address public router = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //v2 PS mainnet
